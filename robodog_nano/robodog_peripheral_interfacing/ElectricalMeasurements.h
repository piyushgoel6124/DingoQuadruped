#ifndef _ROS_robodog_peripheral_interfacing_ElectricalMeasurements_h
#define _ROS_robodog_peripheral_interfacing_ElectricalMeasurements_h
...
namespace robodog_peripheral_interfacing
{
  ...
  class ElectricalMeasurements : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robodog_peripheral_interfacing/ElectricalMeasurements"; };
