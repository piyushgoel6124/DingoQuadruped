...
rospack.get_path('robodog_peripheral_interfacing') + "/lib/emptybatterystatus_white.png"

class RoboDogDisplayNode:
    def __init__(self):
        rospy.init_node('robodog_display_node')
    ...
    def run(self):
        try:
            ...
            # draw.text((60, -15), 'RoboDog', fill="RED", font=Font3)
            ...
            batt_status = Image.open(rospack.get_path('robodog_peripheral_interfacing') + "/lib/emptybatterystatus_white.png")
