...
import socket
import platform
from robodog_peripheral_interfacing.msg import ElectricalMeasurements
...
from robodog_control.Controller import Controller
from robodog_input_interfacing.InputInterface import InputInterface
from robodog_control.State import State, BehaviorState
from robodog_control.Kinematics import four_legs_inverse_kinematics
from robodog_control.Config import Configuration
from robodog_control.msg import TaskSpace, JointSpace, Angle
from std_msgs.msg import Bool

if is_physical:
    from robodog_servo_interfacing.HardwareInterface import HardwareInterface
    from robodog_peripheral_interfacing.IMU import IMU
    from robodog_control.Config import Leg_linkage
...
class RoboDogDriver:
    def __init__(self,is_sim, is_physical, use_imu):
        ...
        if self.is_sim:
            self.sim_command_topics = ["/robodog_controller/FR_theta1/command",
                    "/robodog_controller/FR_theta2/command",
                    "/robodog_controller/FR_theta3/command",
                    "/robodog_controller/FL_theta1/command",
                    "/robodog_controller/FL_theta2/command",
                    "/robodog_controller/FL_theta3/command",
                    "/robodog_controller/RR_theta1/command",
                    "/robodog_controller/RR_theta2/command",
                    "/robodog_controller/RR_theta3/command",
                    "/robodog_controller/RL_theta1/command",
                    "/robodog_controller/RL_theta2/command",
                    "/robodog_controller/RL_theta3/command"]
...
def main():
    """Main program
    """
    rospy.init_node("robodog_driver") 
    signal.signal(signal.SIGINT, signal_handler)
    robodog = RoboDogDriver(is_sim, is_physical, use_imu)
    robodog.run()
