...
class DingoMujocoEnv(gym.Env):
    def __init__(self, xml_path="dingo_scene.xml", render_mode=None):
        super(DingoMujocoEnv, self).__init__()
    ...
    def step(self, action):
        ...
        # In dingo_scene.xml, we have 12 motor actuators.
        for i in range(12):
