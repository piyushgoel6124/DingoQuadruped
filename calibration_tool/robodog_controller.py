#!/usr/bin/env python3
"""
RoboDog Quadruped - Persistent Calibration & Over-the-Wire Controller Client

This utility allows you to establish a serial communication session with the Arduino Uno
to perform real-time joint calibration and control the RoboDog Quadruped over a wired USB connection.
...
def main():
    print("====================================================")
    print(" RoboDog Quadruped Wire Calibration & Control Utility ")
    print("====================================================")
    ...
    controller = RoboDogController(selected_port)
